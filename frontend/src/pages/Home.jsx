      ...
      <section className="features">
        ...
        <div className="features-grid">
          ...
          <div className="feature-card">
            ...
            <p>Verify any certificate in seconds by simply entering the certificate ID or scanning QR code.</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">🌐</div>
            <h3>Global Access</h3>
      ...
      <section className="how-it-works">
        ...
        <div className="steps">
          <div className="step">
            ...
            <p>Connect your MetaMask or Web3 wallet to get started</p>
          </div>
